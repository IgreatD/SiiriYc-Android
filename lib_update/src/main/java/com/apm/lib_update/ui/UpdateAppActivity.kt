...
import com.apm.lib_update.config.UiType
import com.apm.lib_update.extension.*
import com.apm.lib_update.update.DownloadAppUtils
import com.apm.lib_update.update.UpdateAppService
import com.apm.lib_update.update.UpdateAppUtils
import com.apm.lib_update.utils.AlertDialogUtil
...
internal class UpdateAppActivity : AppCompatActivity() {
    ...
    private fun initView() {
        ...
        cancelBtn?.setOnClickListener {
            updateConfig.force.yes {
                ...
                finish()
                UpdateAppUtils.onFinishBtnClickListener?.onClick()
            }
        }
    ...
    override fun onBackPressed() {
        UpdateAppUtils.onBackPressClickListener?.onClick()
    }
